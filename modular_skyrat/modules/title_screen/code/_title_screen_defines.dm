...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_clamp/icons/UI_Icons/title_screen/clamp_title_screen.png' // CLAMP EDIT START: TITLE SCREEN - old value: 'modular_skyrat/modules/title_screen/icons/skyrat_title_screen.png'
